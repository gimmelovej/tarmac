...
// Pontuação e operadores. Os de dois caracteres (`==`, `>=`, `<=`) são resolvidos olhando o
// caractere seguinte antes de fechar o token de um caractere só.
static Token scan_symbol(Lexer *lx)
{
    ...
    case '+': return make_token(lx, Plus);
